...
\begin{enumerate}
	...
	\item to evaluate the model performance using performance metrics such as accuracy, precision, recall, F1 Score, and AUC-ROC score for deep learning, and optimize the performance by performing hyperparameter optimization.
