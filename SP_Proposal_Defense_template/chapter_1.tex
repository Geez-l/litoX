...
To achieve the general objective of developing a non-invasive sex identification of \textit{T. granosa} integrating machine, deep learning, and computer vision technologies. In connection to this, the following specific objectives have been established:
...
\begin{enumerate}
   ...
   \item To develop and implement machine learning models for pre-evaluation that can classify the sex of \textit{T. granosa} based on the collected dataset, implementing commonly used machine learning algorithms such as support vector machines (SVM), Linear Regression, Random Forest and Extreme Gradient Boosting  for pre-evaluation, and implementing deep learning models such as Squeezenet and Unet for further complex analysis. 
   
   \item To develop a deep learning CNN models in complex classification of the images with different angles in order to accurately differentiate the sexual dimorphism between the male and female samples. 
