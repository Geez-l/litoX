...
\begin{enumerate}
   ...
   \item To develop and implement machine learning and deel learning models that can classify the sex of \textit{T. granosa} based on the collected linear measurements and images of different angles of the sample.
